...
export const getVisits =
    (page: number): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const updateMedia =
    (type: string, count = 10): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const updateIata =
    (type: string): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const saveUser =
    (email: string, name: string, password: string | null, enabled: boolean): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const saveNote =
    (id: number | undefined, title: string, content: string): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const saveFlight =
    (data: Flight): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
...
export const saveSetting =
    (key: string, value: string | null): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
...
export const getHass =
    (count = 25): ThunkResult<Promise<void>> =>
    async (dispatch, getState): Promise<void> => {
        if (getState().auth.isLoggedIn) {
