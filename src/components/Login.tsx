    ...
    return (
        <Box title="Login">
            ...
            <form className="mx-auto max-w-max space-y-16" onSubmit={handleSubmit}>
                <input type="email" ref={username} placeholder="E-mail" aria-label="E-mail" autoComplete="off" className={inputCenter} />
                <input type="password" ref={password} placeholder="********" aria-label="Password" className={inputCenter} />
                <input type="submit" value="Submit" aria-label="Login" className={inputCenter} />
